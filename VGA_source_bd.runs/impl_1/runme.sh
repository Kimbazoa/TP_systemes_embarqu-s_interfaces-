...
HD_PWD='C:/Users/on220149/VGA_source_bd/VGA_source_bd.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_source_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VGA_source_bd_wrapper.tcl -notrace
