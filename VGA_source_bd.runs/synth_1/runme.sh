...
HD_PWD='C:/Users/on220149/VGA_source_bd/VGA_source_bd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_source_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VGA_source_bd_wrapper.tcl
