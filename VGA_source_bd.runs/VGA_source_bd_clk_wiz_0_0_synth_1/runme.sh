...
HD_PWD='C:/Users/on220149/VGA_source_bd/VGA_source_bd.runs/VGA_source_bd_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_source_bd_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VGA_source_bd_clk_wiz_0_0.tcl
